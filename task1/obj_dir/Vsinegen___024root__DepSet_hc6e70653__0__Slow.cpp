...
VL_ATTR_COLD void Vsinegen___024root___initial__TOP__0(Vsinegen___024root* vlSelf) {
    ...
    // Init
    VlWide<5>/*159:0*/ __Vtemp_hd5db89f0__0;
    // Body
    VL_WRITEF("Loading ROM ... \n");
    __Vtemp_hd5db89f0__0[0U] = 0x2e6d656dU;
    __Vtemp_hd5db89f0__0[1U] = 0x65726f6dU;
    __Vtemp_hd5db89f0__0[2U] = 0x2f73696eU;
    __Vtemp_hd5db89f0__0[3U] = 0x61736b31U;
    __Vtemp_hd5db89f0__0[4U] = 0x74U;
    VL_READMEM_N(true, 8, 256, 0, VL_CVT_PACK_STR_NW(5, __Vtemp_hd5db89f0__0)
                 ,  &(vlSelf->sinegen__DOT__u_rom__DOT__rom_array)
                 , 0, ~0ULL);
}

VL_ATTR_COLD void Vsinegen___024root___settle__TOP__0(Vsinegen___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsinegen__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsinegen___024root___settle__TOP__0\n"); );
    // Body
    vlSelf->sig_out = vlSelf->sinegen__DOT__data;
}
...
VL_ATTR_COLD void Vsinegen___024root___eval_settle(Vsinegen___024root* vlSelf) {
    ...
    // Body
    Vsinegen___024root___settle__TOP__0(vlSelf);
}
...
VL_ATTR_COLD void Vsinegen___024root___ctor_var_reset(Vsinegen___024root* vlSelf) {
    ...
    vlSelf->sig_out = VL_RAND_RESET_I(8);
    vlSelf->sinegen__DOT__addr = VL_RAND_RESET_I(8);
    vlSelf->sinegen__DOT__data = VL_RAND_RESET_I(8);
    for (int __Vi0=0; __Vi0<256; ++__Vi0) {
        vlSelf->sinegen__DOT__u_rom__DOT__rom_array[__Vi0] = VL_RAND_RESET_I(8);
    }
    vlSelf->__Vdly__sinegen__DOT__addr = VL_RAND_RESET_I(8);
}
